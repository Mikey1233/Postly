...
const NAV_ICONS: Record<string, React.ReactNode> = {
  ...
  feeds: <Icon d="M3.75 3a.75.75 0 00-.75.75v.5c0 .414.336.75.75.75A15.75 15.75 0 0119.5 20.75c0 .414.336.75.75.75h.5a.75.75 0 00.75-.75C21.5 10.59 13.41 2.5 3.75 2.5v.5z" d2="M3 9.75v.5c0 .414.336.75.75.75A8.75 8.75 0 0112.5 19.75v.5c0 .414.336.75.75.75h.5a.75.75 0 00.75-.75C14.5 13.71 9.79 9 3.75 9h-.5a.75.75 0 00-.25.75zM5 18.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />,
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <NavItem to="/feeds"     label="Feeds"     iconKey="feeds"     collapsed={collapsed} />
